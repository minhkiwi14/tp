...
public class UniquePersonList implements Iterable<Person> {
    ...
    public void setPerson(Person target, Person editedPerson) {
        ...
        boolean alreadyContainsPerson = contains(editedPerson);
        boolean isIdChanged = !target.getId().equals(editedPerson.getId());
        boolean listContainsId = containsSameId(editedPerson);

        if (!areSamePeople && alreadyContainsPerson) {
            throw new DuplicatePersonException();
        }

        if (isIdChanged && listContainsId) {
     ...
     * Guarantees: {@code replacement} does not contain duplicate persons.
     */
