...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_ID =
                "The student ID provided is not found in the system.";
    public static final String MESSAGE_PERSONS_LISTED_OVERVIEW =
                "%1$d person(s) listed! Use the \"list\" command to remove filter.";
